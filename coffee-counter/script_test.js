...
describe.only('Slice 2: Unlocking & Rendering Producers', function() {
  ...
  describe.only('The makeProducerDiv function', function() {
    const producer = {
      id: 'producer_A',
      price: 57,
      unlocked: true,
  ...
  describe.only('The clickCoffee function', function() {
    // Clear out our fake DOM.
    beforeEach('reset the fake DOM', function() {
      resetJSDOM();
    });
...
describe.only('Slice 3: Buying Producers & Tick', function() {
